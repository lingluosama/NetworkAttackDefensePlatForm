...
import com.lingluo.attackdefendplatform.service.OssService;
...
public class MinioOssService implements OssService {
    ...
    public FileInfo uploadFile(MultipartFile file) {
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ...
            uploads.setName(file.getOriginalFilename());
            uploads.setUrl(fileUrl);
            boolean save = uploadsService.save(uploads);
